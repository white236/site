        ...
        <div className="reveal bg-white rounded-[2.5rem] overflow-hidden shadow-card-hover border border-cream-deeper">
          ...
          <div className="p-8 sm:p-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
              <a
                href="tel:0620711975"
                className="btn-glow group flex-1 sm:flex-none sm:min-w-[220px] bg-brand-orange text-white font-heading font-black text-base px-8 py-4 rounded-2xl hover:bg-brand-orange-dark transition-all duration-300 hover:-translate-y-0.5 flex items-center justify-center gap-3"
              >
              ...
              <a
                ...
                className="btn-glow-green group flex-1 sm:flex-none sm:min-w-[220px] bg-[#25D366] text-white font-heading font-black text-base px-8 py-4 rounded-2xl hover:bg-[#1ebe5d] transition-all duration-300 hover:-translate-y-0.5 flex items-center justify-center gap-3"
              >
