...
const LavenderSVG = ({ size }) => (
  ...
  >
    {/* Stem */}
    <line x1="11" y1="54" x2="11" y2="14" stroke="#8FA06B" strokeWidth="1.6" strokeLinecap="round" />
    {/* Lower branches */}
    <line x1="11" y1="42" x2="4"  y2="32" stroke="#8FA06B" strokeWidth="1.2" strokeLinecap="round" />
    <line x1="11" y1="42" x2="18" y2="32" stroke="#8FA06B" strokeWidth="1.2" strokeLinecap="round" />
    {/* Upper branches */}
    <line x1="11" y1="29" x2="4"  y2="20" stroke="#8FA06B" strokeWidth="1.1" strokeLinecap="round" />
    <line x1="11" y1="29" x2="18" y2="20" stroke="#8FA06B" strokeWidth="1.1" strokeLinecap="round" />
    {/* Tip flowers */}
    <ellipse cx="11" cy="12" rx="2.6" ry="4.2" fill="#9BAFF2" />
    <ellipse cx="11" cy="7"  rx="2.1" ry="3.4" fill="#7B9DE4" />
    <ellipse cx="11" cy="3"  rx="1.6" ry="2.6" fill="#8B9FE8" />
    {/* Lower flower pairs */}
    <ellipse cx="4"  cy="30" rx="2.1" ry="3.2" fill="#9BAFF2" opacity="0.88" />
    <ellipse cx="18" cy="30" rx="2.1" ry="3.2" fill="#9BAFF2" opacity="0.88" />
    {/* Upper flower pairs */}
    <ellipse cx="4"  cy="18" rx="1.9" ry="3"   fill="#7B9DE4" opacity="0.82" />
    <ellipse cx="18" cy="18" rx="1.9" ry="3"   fill="#7B9DE4" opacity="0.82" />
    {/* Tiny leaf nubs */}
    <ellipse cx="11" cy="20" rx="1"   ry="1.5" fill="#8FA06B" opacity="0.5" />
    <ellipse cx="11" cy="33" rx="1"   ry="1.5" fill="#8FA06B" opacity="0.4" />
  </svg>
)
...
const PetalSVG = ({ size }) => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    {/* 5 petals rotating around center */}
...
const LeafSVG = ({ size }) => (
  ...
  >
    ...
    {/* Petiole */}
    <line x1="17" y1="27" x2="17" y2="30" stroke="#8FA06B" strokeWidth="1"   strokeLinecap="round" opacity="0.5" />
  </svg>
)
...
const ELEMENTS = [
  ...
  { type: 'petal',    top: 78, delay: 5,  dur: 20, size: 17, op: 0.50, dir: 'right', rs: -50, re: 30,  ye: -20 },
  ...
  { type: 'petal',    top: 85, delay: 31, dur: 22, size: 20, op: 0.44, dir: 'left',  rs: 60,  re: 140, ye: 15  },
  { type: 'lavender', top: 45, delay: 7,  dur: 34, size: 32, op: 0.30, dir: 'right', rs: -8,  re: 12,  ye: -38 },
]

const SVG_MAP = { lavender: LavenderSVG, petal: PetalSVG, leaf: LeafSVG }
